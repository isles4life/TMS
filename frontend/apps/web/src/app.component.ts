...
export class AppComponent {
  ...
  navItemsBase: NavItem[] = [
    ...
    { label: 'Vendors', icon: 'build', path: '/maintenance/vendors', roles: ['Broker', 'SuperAdmin'] },
    { label: 'PM Schedules', icon: 'event_repeat', path: '/maintenance/schedules', roles: ['Broker', 'SuperAdmin'] },
    { label: 'Work Orders', icon: 'assignment', path: '/maintenance/work-orders', roles: ['Broker', 'SuperAdmin'] },
